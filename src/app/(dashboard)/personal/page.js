        ...
        <div className="w-full h-full flex flex-col items-center relative overflow-visible">
            ...
            <div className="w-full text-center py-6 md:py-10 mb-2 animate__animated animate__fadeIn relative flex flex-col items-center justify-center">
                <div className="relative z-10 w-full px-4">
                    <h1 className="text-2xl sm:text-3xl md:text-5xl font-black mb-2 tracking-tight text-gradient-premium bg-clip-text uppercase">
                        Personal Profile
                    </h1>
                        ...
                        <form onSubmit={handleRequestSubmit} className="flex-1 overflow-y-auto p-5 sm:p-8 md:p-10 space-y-6 sm:space-y-8 md:space-y-10 custom-scrollbar">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 sm:gap-x-12 gap-y-4 sm:gap-y-6 md:gap-y-8">
                                <div className="space-y-1 sm:space-y-1.5 md:space-y-2">
                                    <label className="text-[9px] sm:text-[10px] font-black text-[#153A6A] uppercase tracking-widest">First Name</label>
                                    <input
                                        type="text"
                                        className="w-full bg-gray-50 border-2 border-gray-100 rounded-xl px-4 py-2 sm:py-2.5 md:py-3 text-xs sm:text-sm focus:border-[#4A4A4A] outline-none transition-all font-bold text-black"
                                        value={updateData.firstName}
                                        onChange={(e) => setUpdateData({ ...updateData, firstName: e.target.value })}
                                    />
                                </div>
                                <div className="space-y-1 sm:space-y-1.5 md:space-y-2">
                                    <label className="text-[9px] sm:text-[10px] font-black text-[#153A6A] uppercase tracking-widest">Last Name</label>
                                    <input
                                        type="text"
                                        className="w-full bg-gray-50 border-2 border-gray-100 rounded-xl px-4 py-2 sm:py-2.5 md:py-3 text-xs sm:text-sm focus:border-[#4A4A4A] outline-none transition-all font-bold text-black"
                                ...
                                <div className="space-y-1 sm:space-y-1.5 md:space-y-2">
                                    <label className="text-[9px] sm:text-[10px] font-black text-[#153A6A] uppercase tracking-widest">Gender</label>
                                    <div className="relative">
                                        <select
                                            className="w-full bg-gray-50 border-2 border-gray-100 rounded-xl px-4 py-2 sm:py-2.5 md:py-3 text-xs sm:text-sm focus:border-[#4A4A4A] outline-none transition-all font-bold text-black appearance-none"
                                ...
                                <div className="space-y-1 sm:space-y-1.5 md:space-y-2">
                                    <label className="text-[9px] sm:text-[10px] font-black text-[#153A6A] uppercase tracking-widest">Contact Number</label>
                                    <input
                                        type="tel"
                                        className="w-full bg-gray-50 border-2 border-gray-100 rounded-xl px-4 py-2 sm:py-2.5 md:py-3 text-xs sm:text-sm focus:border-[#4A4A4A] outline-none transition-all font-bold text-black"
                                ...
                                <div className="space-y-1 sm:space-y-1.5 md:space-y-2">
                                    <label className="text-[9px] sm:text-[10px] font-black text-[#153A6A] uppercase tracking-widest">Email Address</label>
                                    <input
                                        type="email"
                                        className="w-full bg-gray-50 border-2 border-gray-100 rounded-xl px-4 py-2 sm:py-2.5 md:py-3 text-xs sm:text-sm focus:border-[#4A4A4A] outline-none transition-all font-bold text-black"
                                ...
                                <div className="space-y-1 sm:space-y-1.5 md:space-y-2">
                                    <label className="text-[9px] sm:text-[10px] font-black text-[#153A6A] uppercase tracking-widest">NRIC</label>
                                    <input
                                        type="text"
                                        className="w-full bg-gray-50 border-2 border-gray-100 rounded-xl px-4 py-2 sm:py-2.5 md:py-3 text-xs sm:text-sm focus:border-[#4A4A4A] outline-none transition-all font-bold text-black"
                                ...
                                <div className="space-y-1 sm:space-y-1.5 md:space-y-2">
                                    <label className="text-[9px] sm:text-[10px] font-black text-[#153A6A] uppercase tracking-widest">Nationality</label>
                                    <input
                                        type="text"
                                        className="w-full bg-gray-50 border-2 border-gray-100 rounded-xl px-4 py-2 sm:py-2.5 md:py-3 text-xs sm:text-sm focus:border-[#4A4A4A] outline-none transition-all font-bold text-black"
                                ...
                                <div className="space-y-1 sm:space-y-1.5 md:space-y-2">
                                    <label className="text-[9px] sm:text-[10px] font-black text-[#153A6A] uppercase tracking-widest">Registered Address</label>
                                    <textarea
                                        rows={2}
                                        className="w-full bg-gray-50 border-2 border-gray-100 rounded-xl px-4 py-2 sm:py-2.5 md:py-3 text-xs sm:text-sm focus:border-[#4A4A4A] outline-none transition-all font-bold text-black resize-none"
