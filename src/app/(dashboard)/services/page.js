                        ...
                        {services.map((service, idx) => (
                            <div key={idx} className="group p-5 sm:p-6 flex flex-col sm:flex-row sm:items-center justify-between hover:bg-gray-50 transition-all duration-300">
                                <div className="flex items-center gap-4 mb-4 sm:mb-0">
                                    <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-gradient-gold flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                                    ...
                                    <h3 className="text-base sm:text-lg font-bold text-gray-900 tracking-tight group-hover:text-[#A67C00] transition-colors">
                                        {service.name}
                                    </h3>
                                </div>
