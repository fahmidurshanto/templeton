        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={onClose}>
            ...
            >
                <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-2xl bg-gradient-gold flex items-center justify-center shadow-lg">
                        <svg className="w-6 h-6 text-black" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v16m8-8H4" />
                        </svg>
                    </div>
                    <div>
                        <p className="text-[11px] font-black uppercase tracking-[0.2em] text-[#D4AF37]">Management</p>
                ...
                <div className="space-y-2">
                    ...
                    <input
                        ...
                        className="w-full px-5 py-3.5 bg-gray-50 border-2 border-gray-100 rounded-xl focus:border-[#D4AF37] focus:bg-white transition-all duration-200 outline-none font-bold text-gray-700 placeholder:text-gray-300 shadow-inner"
                    />
                </div>
                ...
                <div className="flex gap-4 pt-2">
                    ...
                    <button
                        ...
                        className="flex-1 px-6 py-3.5 rounded-xl text-xs font-black uppercase tracking-[0.15em] bg-gradient-gold text-black shadow-lg shadow-amber-200/50 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 disabled:opacity-50 disabled:grayscale disabled:pointer-events-none"
                    >
                        Create Service
                    </button>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-2xl border-2 border-[#D4AF37]/30 overflow-hidden">
                    <div className="bg-gradient-gold px-8 py-5 flex items-center justify-between border-b border-[#b38b22]/30">
                        ...
                        <button
                            ...
                            className="bg-black text-[#D4AF37] px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-black/80 transition-all duration-200 flex items-center gap-2 shadow-xl shadow-black/10 active:scale-95"
                        >
