        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={onClose}>
            ...
            >
                <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-2xl bg-gradient-premium flex items-center justify-center shadow-lg">
                        <svg className="w-6 h-6 text-black" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v16m8-8H4" />
                        </svg>
                    </div>
                    <div>
                        <p className="text-[11px] font-black uppercase tracking-[0.2em] text-[#4A4A4A]">Management</p>
                ...
                <div className="space-y-2">
                    ...
                    <input
                        ...
                        className="w-full px-5 py-3.5 bg-gray-50 border-2 border-gray-100 rounded-xl focus:border-[#4A4A4A] focus:bg-white transition-all duration-200 outline-none font-bold text-gray-700 placeholder:text-gray-300 shadow-inner"
                    />
                </div>
                ...
                <div className="flex gap-4 pt-2">
                    ...
                    <button
                        ...
                        className="flex-1 px-6 py-3.5 rounded-xl text-xs font-black uppercase tracking-[0.15em] bg-gradient-premium text-black shadow-lg shadow-amber-200/50 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 disabled:opacity-50 disabled:grayscale disabled:pointer-events-none"
                    >
                        Create Service
                    </button>
                </div>
        ...
        <div className="w-full h-full flex flex-col items-center relative overflow-visible">
            ...
            <div className="w-full text-center py-8 md:py-14 mb-6 animate__animated animate__fadeIn relative flex flex-col items-center justify-center min-h-[25vh]">
                <div className="relative z-10 w-full">
                    <h1 className="text-3xl md:text-5xl font-bold mb-3 tracking-wide text-gradient-premium bg-clip-text uppercase">
                        Our Services
                    </h1>
                        ...
                        {services.map((service, idx) => (
                            <div key={idx} className="group p-6 flex flex-col sm:flex-row sm:items-center justify-between hover:bg-gray-50 transition-all duration-300">
                                <div className="flex items-center gap-4 mb-3 sm:mb-0">
                                    ...
                                    <h3 className="text-lg font-bold text-gray-900 tracking-tight group-hover:text-[#153A6A] transition-colors">
                                        {service.name}
                                    </h3>
                                </div>
