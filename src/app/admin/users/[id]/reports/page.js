                            ...
                            <div>
                                <h2 className="text-2xl md:text-3xl font-bold text-gray-900">
                                    {viewMode === 'monthly'
                                        ...
                                        : <>Yearly <span className="text-[#D4AF37]">Overview</span></>
                                    }
                                </h2>
                    ...
                    {loading ? (
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                            {displayData.map((data) => (
                                <div key={data.label} className="p-5 border border-gray-100 rounded-2xl bg-gray-50 hover:bg-gray-100/50 hover:border-[#D4AF37]/30 transition-all flex flex-col justify-between group">
                                            ...
                                            <tr key={d.label} className="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                                ...
                                                <td className="py-4 px-4 text-right">
                                                    <button
                                                        ...
                                                        className="px-4 py-1.5 text-[9px] font-black uppercase tracking-widest rounded-lg border border-[#D4AF37]/40 text-[#A67C00] hover:bg-gradient-gold hover:text-black transition-all"
                                                    >
                                                        Edit Months
                                                    </button>
                                                </td>
