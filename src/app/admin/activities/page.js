                ...
                {isLoading ? (
                    ...
                    <div className="space-y-8">
                        {activitiesData[activeTab].map((activity) => (
                            <div key={activity.id} className="group bg-white shadow-2xl border border-gray-50 overflow-hidden hover:border-[#4A4A4A]/40 transition-all duration-500 hover:scale-[1.01] flex flex-col sm:flex-row rounded-[2rem]">
                                ...
                                <div className="flex-1 p-6 sm:p-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 sm:gap-8">
                                    <div className="flex-1 w-full sm:w-auto">
                                        <div className="flex items-center gap-4 mb-3">
                                            ...
                                            <div className="text-[9px] sm:text-[10px] text-[#153A6A] font-black uppercase tracking-[0.2em]">{activity.time}</div>
                                        </div>
                                        <h3 className="text-xl sm:text-2xl font-black text-gray-950 tracking-tight group-hover:text-[#153A6A] transition-colors mb-2 uppercase">
                                            {activity.title}
                                        </h3>
                                    ...
                                    <div className="flex flex-col items-start sm:items-end gap-3 shrink-0 w-full sm:w-auto">
                                        <div className="text-left sm:text-right bg-gray-50/50 px-4 py-3 rounded-xl border border-gray-50 w-full sm:min-w-[140px]">
                                            ...
                                            <div className="mt-2 text-[#4A4A4A] font-black text-[10px] sm:text-xs tracking-tight">{activity.date}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
