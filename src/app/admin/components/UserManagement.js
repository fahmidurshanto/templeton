                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12">
                                    ...
                                    <div className="space-y-6 sm:space-y-8">
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                            <div>
                                                <label className="block text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] text-gradient-gold mb-1.5 sm:mb-2">First Name</label>
                                            ...
                                            <div>
                                                <label className="block text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] text-gradient-gold mb-1.5 sm:mb-2">Last Name</label>
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                            ...
                                            <div>
                                                <label className="block text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] text-gradient-gold mb-1.5 sm:mb-2">Nationality</label>
                                        ...
                                        <div>
                                            <label className="block text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] text-gradient-gold mb-1.5 sm:mb-2">NRIC / Passport No.</label>
                                        ...
                                        <div>
                                            <label className="block text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] text-gradient-gold mb-1.5 sm:mb-2">Full Address</label>
                                    ...
                                    <div className="space-y-6 sm:space-y-8">
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                            <div>
                                                <label className="block text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] text-gradient-gold mb-1.5 sm:mb-2">Account Status</label>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div>
                                                <label className="block text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] text-gradient-gold mb-1.5 sm:mb-2">Phone Number</label>
                                        ...
                                        <div className="flex flex-col space-y-4">
                                            <div>
                                                <label className="block text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] text-gradient-gold mb-1.5 sm:mb-2">Secondary Email</label>
                                            ...
                                            <div>
                                                <label className="block text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] text-gradient-gold mb-1.5 sm:mb-2">Secondary Phone</label>
            ...
            <div className="w-full animate__animated animate__fadeIn relative overflow-hidden">
                <div className="relative z-10 w-full space-y-6">
                    ...
                    <div className="relative group px-1 sm:px-0">
                        <svg className="absolute left-5 sm:left-6 top-1/2 -translate-y-1/2 w-4 sm:w-5 h-4 sm:h-5 text-gray-400 group-focus-within:text-[#D4AF37] transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                        ...
                        <input
                            ...
                            className="w-full pl-12 sm:pl-16 pr-6 py-3.5 sm:py-5 rounded-2xl bg-white border-2 border-gray-50 text-gray-950 font-bold text-xs sm:text-sm placeholder-gray-400 focus:outline-none focus:border-[#D4AF37] transition-all shadow-xl"
                        />
                    </div>
                                                ...
                                                <td className="px-4 sm:px-6 py-4 sm:py-5">
                                                    <div className="flex items-center gap-3 sm:gap-4">
                                                        ...
                                                        <div className="min-w-0">
                                                            <p className="text-xs sm:text-sm text-gray-950 font-bold group-hover:text-[#A67C00] transition-colors truncate">{u.firstName ? `${u.firstName} ${u.lastName}` : u.name}</p>
