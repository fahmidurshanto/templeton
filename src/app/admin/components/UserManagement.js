                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12">
                                    ...
                                    <div className="space-y-6 sm:space-y-8">
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                            <div>
                                                <label className="block text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] text-gradient-premium mb-1.5 sm:mb-2">First Name</label>
                                                <input required type="text" className="w-full bg-gray-50 border-2 border-gray-100 rounded-xl px-3 sm:px-4 py-2.5 sm:py-3 text-xs sm:text-sm focus:border-[#4A4A4A] outline-none transition-all font-bold text-black" value={formData.firstName} onChange={(e) => setFormData({ ...formData, firstName: e.target.value })} />
                                            </div>
                                            <div>
                                                <label className="block text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] text-gradient-premium mb-1.5 sm:mb-2">Last Name</label>
                                                <input required type="text" className="w-full bg-gray-50 border-2 border-gray-100 rounded-xl px-3 sm:px-4 py-2.5 sm:py-3 text-xs sm:text-sm focus:border-[#4A4A4A] outline-none transition-all font-bold text-black" value={formData.lastName} onChange={(e) => setFormData({ ...formData, lastName: e.target.value })} />
                                            </div>
                                        </div>
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                            <div>
                                                <label className="block text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] text-gradient-premium mb-1.5 sm:mb-2">Gender</label>
                                                <select className="w-full bg-gray-50 border-2 border-gray-100 rounded-xl px-3 sm:px-4 py-2.5 sm:py-3 text-xs sm:text-sm focus:border-[#4A4A4A] outline-none transition-all font-bold text-black cursor-pointer" value={formData.gender} onChange={(e) => setFormData({ ...formData, gender: e.target.value })}>
                                            ...
                                            <div>
                                                <label className="block text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] text-gradient-premium mb-1.5 sm:mb-2">Nationality</label>
                                                <input required type="text" className="w-full bg-gray-50 border-2 border-gray-100 rounded-xl px-3 sm:px-4 py-2.5 sm:py-3 text-xs sm:text-sm focus:border-[#4A4A4A] outline-none transition-all font-bold text-black" placeholder="Singaporean" value={formData.nationality} onChange={(e) => setFormData({ ...formData, nationality: e.target.value })} />
                                            </div>
                                        </div>
                                        <div>
                                            <label className="block text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] text-gradient-premium mb-1.5 sm:mb-2">NRIC / Passport No.</label>
                                            <input required type="text" className="w-full bg-gray-50 border-2 border-gray-100 rounded-xl px-3 sm:px-4 py-2.5 sm:py-3 text-xs sm:text-sm focus:border-[#4A4A4A] outline-none transition-all font-bold text-black" placeholder="S1234567A" value={formData.nric} onChange={(e) => setFormData({ ...formData, nric: e.target.value })} />
                                        </div>
                                        <div>
                                            <label className="block text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] text-gradient-premium mb-1.5 sm:mb-2">Full Address</label>
                                            <textarea required rows={2} className="w-full bg-gray-50 border-2 border-gray-100 rounded-xl px-3 sm:px-4 py-2.5 sm:py-3 text-xs sm:text-sm focus:border-[#4A4A4A] outline-none transition-all font-bold text-black resize-none" placeholder="Enter full address" value={formData.address} onChange={(e) => setFormData({ ...formData, address: e.target.value })} />
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-6 sm:space-y-8">
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                            <div>
                                                <label className="block text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] text-gradient-premium mb-1.5 sm:mb-2">Account Status</label>
                                                <select className="w-full bg-gray-50 border-2 border-gray-100 rounded-xl px-3 sm:px-4 py-2.5 sm:py-3 text-xs sm:text-sm focus:border-[#4A4A4A] outline-none transition-all font-bold text-black cursor-pointer" value={formData.status} onChange={(e) => setFormData({ ...formData, status: e.target.value })}>
                                        ...
                                        <div className="space-y-4">
                                            <div>
                                                <label className="block text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] text-gradient-premium mb-1.5 sm:mb-2">Corporate Email</label>
                                                <input required type="email" className="w-full bg-gray-50 border-2 border-gray-100 rounded-xl px-3 sm:px-4 py-2.5 sm:py-3 text-xs sm:text-sm focus:border-[#4A4A4A] outline-none transition-all font-bold text-black" placeholder="partner@company.com" value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} />
                                            </div>
                                            <div>
                                                <label className="block text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] text-gradient-premium mb-1.5 sm:mb-2">Phone Number</label>
                                                <input required type="tel" className="w-full bg-gray-50 border-2 border-gray-100 rounded-xl px-3 sm:px-4 py-2.5 sm:py-3 text-xs sm:text-sm focus:border-[#4A4A4A] outline-none transition-all font-bold text-black" placeholder="+65 8888 8888" value={formData.Phone} onChange={(e) => setFormData({ ...formData, Phone: e.target.value })} />
                                            </div>
                                        </div>

                                        <div className="flex flex-col space-y-4">
                                            <div>
                                                <label className="block text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] text-gradient-premium mb-1.5 sm:mb-2">Secondary Email</label>
                                                <input type="email" className="w-full bg-gray-50 border-2 border-gray-100 rounded-xl px-3 sm:px-4 py-2.5 sm:py-3 text-xs sm:text-sm focus:border-[#4A4A4A] outline-none transition-all font-bold text-black" placeholder="Optional" value={formData.secondaryEmail} onChange={(e) => setFormData({ ...formData, secondaryEmail: e.target.value })} />
                                            </div>
                                            <div>
                                                <label className="block text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] text-gradient-premium mb-1.5 sm:mb-2">Secondary Phone</label>
                                                <input type="tel" className="w-full bg-gray-50 border-2 border-gray-100 rounded-xl px-3 sm:px-4 py-2.5 sm:py-3 text-xs sm:text-sm focus:border-[#4A4A4A] outline-none transition-all font-bold text-black" placeholder="Optional" value={formData.secondaryPhone} onChange={(e) => setFormData({ ...formData, secondaryPhone: e.target.value })} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div className="w-full animate__animated animate__fadeIn relative overflow-hidden">
                <div className="relative z-10 w-full space-y-6">
                    ...
                    <div className="relative group px-1 sm:px-0">
                        <svg className="absolute left-5 sm:left-6 top-1/2 -translate-y-1/2 w-4 sm:w-5 h-4 sm:h-5 text-gray-400 group-focus-within:text-[#4A4A4A] transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                        ...
                        <input
                            ...
                            className="w-full pl-12 sm:pl-16 pr-6 py-3.5 sm:py-5 rounded-2xl bg-white border-2 border-gray-50 text-gray-950 font-bold text-xs sm:text-sm placeholder-gray-400 focus:outline-none focus:border-[#4A4A4A] transition-all shadow-xl"
                        />
                    </div>
                                    ...
                                    {isLoadingUsers ? (
                                        <tr>
                                            <td colSpan="4" className="px-6 py-20 text-center">
                                                <div className="flex flex-col items-center justify-center gap-4">
                                                    <div className="w-12 h-12 border-4 border-[#4A4A4A] border-t-transparent rounded-full animate-spin"></div>
                                        ...
                                        filtered.map((u) => (
                                            ...
                                            >
                                                <td className="px-4 sm:px-6 py-4 sm:py-5">
                                                    <div className="flex items-center gap-3 sm:gap-4">
                                                        ...
                                                        <div className="min-w-0">
                                                            <p className="text-xs sm:text-sm text-gray-950 font-bold group-hover:text-[#153A6A] transition-colors truncate">{u.firstName ? `${u.firstName} ${u.lastName}` : u.name}</p>
                                                ...
                                                <td className="px-4 sm:px-6 py-4 text-[#4A4A4A] font-black text-[10px] sm:text-xs hidden lg:table-cell font-mono truncate max-w-[120px]" title={u.password}>
                                                    {u.password || '••••••'}
                                                </td>
