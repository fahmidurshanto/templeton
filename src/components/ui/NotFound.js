...
export default function NotFound({ 
    ...
    return (
        <div className="w-full min-h-[70vh] flex flex-col items-center justify-center relative overflow-hidden px-4">
            ...
            <div className="hidden sm:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#4A4A4A]/5 rounded-full blur-[120px] pointer-events-none"></div>
            ...
            <div className="relative z-10 text-center max-w-xl animate__animated animate__fadeIn">
                <div className="mb-6 sm:mb-8 relative inline-block">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full border-2 border-[#4A4A4A]/30 flex items-center justify-center bg-white shadow-xl">
                            <svg className="w-8 h-8 sm:w-10 sm:h-10 text-[#4A4A4A]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    ...
                    <button
                        ...
                        className="px-8 py-4 rounded-2xl bg-gradient-premium text-black font-black text-xs uppercase tracking-widest hover:scale-105 shadow-xl hover:shadow-gold-500/20 transition-all w-full sm:w-auto"
                    >
                        {backText}
                    </button>
                </div>
