                        ...
                        <DialogPanel className="w-full max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden">
                            ...
                            <div className="px-6 cursor-pointer py-4 bg-gray-50 border-t border-gray-100 flex justify-end gap-3">
                                ...
                                {footer ?? (
                                    <button
                                        onClick={onClose}
                                        className="px-6 py-2 rounded-lg bg-metallic-pill metallic-text-white text-[11px] font-bold tracking-wide hover:brightness-105 transition-all active:scale-95 flex items-center gap-2"
                                    >
                                        Close
                                    </button>
                                )}
