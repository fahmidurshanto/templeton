                ...
                <div className="flex-1 flex items-center justify-end pr-4 gap-3 h-full">
                    {user && (
                        <div className="flex items-center gap-2">
                            ...
                            <div className="w-8 h-8 rounded-full flex items-center justify-center text-white shadow-sm bg-gradient-premium">
                    ...
                    <button
                        onClick={logout}
                        className="px-4 py-1.5 rounded-full bg-gradient-premium text-gray-900 text-[10px] font-bold shadow-sm transition-all"
                    >
                        Logout
                    </button>
                </div>
